...
GRANT USAGE ON DATABASE DEVELOPMENT TO ROLE DATA_ENGINEER;
GRANT USAGE ON SCHEMA DEVELOPMENT.ETL_SCHEMA TO ROLE DATA_ENGINEER;

-- 2. Grant CREATE (Allowed)
GRANT CREATE PIPE ON SCHEMA DEVELOPMENT.ETL_SCHEMA TO ROLE DATA_ENGINEER;

-- 3. Grant OPERATE on FUTURE pipes (This IS Allowed)
GRANT OPERATE, MONITOR ON FUTURE PIPES IN SCHEMA DEVELOPMENT.ETL_SCHEMA TO ROLE DATA_ENGINEER;